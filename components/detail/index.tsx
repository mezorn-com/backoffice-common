            ...
            <div className={classes.group} key='group'>
                {
                    renderFields.map((field) => {
                        ...
                        return (
                            <SimpleGrid key={field.key} cols={isTable ? 1 : 2} spacing={50} verticalSpacing={'xl'} className={classes.grid}>
                                <span className={classes.label} style={{ textAlign: isTable ? 'left' : 'right' }}>{field.label}</span>
