...
const TableSection = ({ section, table, rowSelect }: TableElementProps) => {
	...
	const visible =
		section === TableSectionType.CENTER || flatHeaders.length > 0;
		...
		>
			...
			>
				...
				{table.getRowModel().rows.length ? (
					...
					// biome-ignore lint/nursery/noNestedTernary: TODO: fix later
				) : flatHeaders.length === 0 ? null : (
					<Placeholder />
				)}
				<div className='tfoot'>
